...
public:
    ...
    static const std::unordered_set<std::string> inline RESERVED_WORDS = {
        "null",
        "none",
        "head"
    };
...
private:
    ...
    const static std::unordered_set<std::string_view> inline preprocessed_tags{
        tags::label, tags::vns, tags::language,
        tags::id
    };
